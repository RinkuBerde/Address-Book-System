...
namespace Address_Book_System
{
    class CsvOperation
    {
        public static void CSVOperation(Dictionary<string, List<AddrBook>> addressbooknames, int option)
        {
            ...
            string csvFilePath = @"C:\Users\RINKU\Desktop\Day-9\Address-Book-System\Address-Book-System\CsvData.csv";
            string jsonfilePath = @"C:\Users\RINKU\Desktop\Day-9\Address-Book-System\Address-Book-System\JsonFile.json";
